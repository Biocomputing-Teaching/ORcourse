...
\date{October 1st-13th, 2025\\last updated: \today}
...
\begin{Exercise}
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
    \note{Gran video explicatiu dels Lagrange multipliers: \url{https://www.youtube.com/watch?v=8mjcnxGMwFo}}
\end{Exercise}
  \begin{Exercise}
...
\framebreak
    ...
    \item \textbf{Dual feasibility (sign condition):}
    \[
