...
\begin{frame}[allowframebreaks]{Complementary slackness}
  ...
  \begin{theorem}
    If in an optimal solution to a LP problem and inequality constraint is not binding, then the dual variable corresponding to that constraint has a value of zero in any optimal solution to the dual problem. 
  \end{theorem}
