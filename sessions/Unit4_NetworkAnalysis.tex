...
\begin{frame}{Graphs and networks: definitions}
    ...
    \end{center}
\begin{itemize}
    \item A graph is a structure consisting of a set of nodes $V$  (vertices, points, or junctions) and a set of connections called arcs $A$ (edges, links, or branches). 
...
\begin{frame}
  ...
  \end{equation*}
  \begin{center}
    \includegraphics[width=0.6\linewidth]{transportationproblem.png}
  \end{center}
\end{frame}
