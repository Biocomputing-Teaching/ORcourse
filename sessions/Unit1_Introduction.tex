...
\begin{frame}{TSP practical example}
  ...
  \end{tabular}
  \end{center}
  Check \href{https://github.com/JordiVillaFreixa/ORcode/blob/850c27677637b22cab9ac72180e5a0047e49f26c/TSPnaive.ipynb}{code} at GitHub 
\end{frame}
  ...
  \begin{columns}[t]
    \begin{column}{.45\textwidth}
      \bibitem[Carter, 2019]{carter} Michael W. Carter, Camille C. Price, and Ghaith Rabadi (2019)
        ...
        \bibitem[Harel, 2004]{harel} David Harel, with Yishai Feldman (2004)
